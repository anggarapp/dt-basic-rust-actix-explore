...
async fn register_user_returns_a_201_for_valid_payload_data_and_login_should_be_success() {
    ...
    // Act
    let response = app
        .payload_for_post(body_data.into(), "api/v1/users/login")
        .await;
...
async fn update_user_returns_a_201_for_valid_payload_data() {
    ...
    // Act
    let response = app
        .payload_for_put(body_data.into(), "api/v1/users/update")
        .await;
...
async fn delete_user_returns_a_200_for_success() {
    ...
    // Act
    let response = app
        .payload_for_delete(body_data.into(), "api/v1/users/delete")
        .await;
